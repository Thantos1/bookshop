...
String actionUrl = "merAction.do?method=searchMerByKeyAndCate&cateId="+cateId;
if(key!=null)
actionUrl = actionUrl + "&key="+key;
 %>
...
<script type="text/javascript">
	...
	var maxPageNo = <%=totalPages%>;
		...
		var url = "merAction.do?method=searchMerByKeyAndCate&pageNo="+goPageNo+"&cateId="+<%=cateId%>;
		var k = <%=key%>
		if(k!=null)
		url = url + "&key="+k;
