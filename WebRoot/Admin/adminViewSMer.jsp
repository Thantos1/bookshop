  ...
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr height="40">
      ...
      <tr height="24">
        ...
        <td>
            <input type="radio" name="special" value="0" readonly="true"/>ÎÞ&nbsp;&nbsp;
            <input type="radio" name="special" value="1" readonly="true" checked/>ÓÐ
      ...
      <tr height="24">
        <td colspan="2" align="center">
			<html:link page="/manageMerAction.do?method=browseSMers">
